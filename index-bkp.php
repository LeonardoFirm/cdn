...
::-webkit-scrollbar-track { background: #2c05f2; }
::-webkit-scrollbar-thumb { background: #2c05f2; }
::-webkit-scrollbar-thumb:hover { background: #2c05f2; }
...
.left-login-image {width: 20vw;}
p {position: absolute; margin: 0 0 0 40%; color: red; text-align: center;}
...
.center { display: flex; justify-content: center; align-items: center; margin: 20% 0 20% 0; } .modal { top: 5%; backdrop-filter: blur(10px); } 
.cc3 {background-image: linear-gradient(to right, #00b4e6,#0084ff,#1432c9,#2c05f2);} </style>
<body>
    <?php if (isset($_SESSION['nao_autenticado'])) : ?> <div class="notification is-danger" role="alert">
    <script>
    javascript:window.prompt('ERRO: Algumas informações estão incorretas. Verifique as credênciais.' , ['Usuário ou Senha']);
    </script>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header cc3">
          <h4 class="modal-title">Aviso</h4>
        </div>
        <div class="modal-body rodape_final" id="rodape_final">
            <h6 class="w3-white w3-padding-16 w3-text-black w3-left w3-small"><article class="w3-light-gray">Atualização Passada:</article> Combos - 10/11/2022 das 11h40 às 15h.<br><br><article class="w3-light-gray">Atualização Passada:</article> Combos - 19/11/2022 das 18h00 às 20h.<br><br><article class="w3-light-gray">Atualização Recente:</article> Correções na API - 12/12/2022 das 21h00 às 02h.<br><br></h6><hr>
          <h6 class="w3-white w3-padding-16 w3-text-black w3-left w3-small"><article class="w3-green">Atualização Recente:</article> Combos - 13/12/2022 das 8h30 às 16h55. <img src="/Image/check.gif" width="20px"/><br><br><article class="w3-green">Atualização Recente:</article> Correções na API - 15/12/2022 das 21h00 às 02h. <img src="/Image/check.gif" width="20px"/><br><br><article class="w3-green">Atualização Recente:</article> Combos - 19/12/2022 das 9h00 às 11h30. <img src="/Image/check.gif" width="20px"/></h6><hr>
            <h6 class="w3-white w3-padding-16 w3-text-red w3-left w3-small"><!--<article class="w3-amber">Próxima atualização:</article> Combos - 19/12/2022 das 9h00 às 17h30. <img src="/Image/loading.gif" width="20px"/><br><br>--><article class="w3-gray w3-text-black">Baterias:</article> Sem atualização no momento. <img src="/Image/about.gif" width="20px"/></h6>
        </div> 
        </div>
